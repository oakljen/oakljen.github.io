 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function mr(s){if(s)try{const t=new Date(Number(s));if(!isNaN(t.getTime()))return t.toUTCString()}catch{}}async function oC(s,t=!1){const i=dt(s),r=await i.getIdToken(t),o=bh(r);X(o&&o.exp&&o.auth_time&&o.iat,i.auth,"internal-error");const c=typeof o.firebase=="object"?o.firebase:void 0,h=c==null?void 0:c.sign_in_provider;return{claims:o,token:r,authTime:mr(Mf(o.auth_time)),issuedAtTime:mr(Mf(o.iat)),expirationTime:mr(Mf(o.exp)),signInProvider:h||null,signInSecondFactor:(c==null?void 0:c.sign_in_second_factor)||null}}function Mf(s){return Number(s)*1e3}function bh(s){const[t,i,r]=s.split(".");if(t===void 0||i===void 0||r===void 0)return ho("JWT malformed, contained fewer than 3 sections"),null;try{const o=Eo(i);return o?JSON.parse(o):(ho("Failed to decode base64 JWT payload"),null)}catch(o){return ho("Caught error parsing JWT payload as JSON",o==null?void 0:o.toString()),null}}function vg(s){const t=bh(s);return X(t,"internal-error"),X(typeof t.exp<"u","internal-error"),X(typeof t.iat<"u","internal-error"),Number(t.exp)-Number(t.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fs{constructor(){this.refreshToken=null,this.accessToken=null,this.expirationTime=null}get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(t){X(t.idToken,"internal-error"),X(typeof t.idToken<"u","internal-error"),X(typeof t.refreshToken<"u","internal-error");const i="expiresIn"in t&&typeof t.expiresIn<"u"?Number(t.expiresIn):vg(t.idToken);this.updateTokensAndExpiration(t.idToken,t.refreshToken,i)}updateFromIdToken(t){X(t.length!==0,"internal-error");const i=vg(t);this.updateTokensAndExpiration(t,null,i)}async getToken(t,i=!1){return!i&&this.accessToken&&!this.isExpired?this.accessToken:(X(this.refreshToken,t,"user-token-expired"),this.refreshToken?(await this.refresh(t,this.refreshToken),this.accessToken):null)}clearRefreshToken(){this.refreshToken=null}async refresh(t,i){const{accessToken:r,refreshToken:o,expiresIn:c}=await dC(t,i);this.updateTokensAndExpiration(r,o,Number(c))}updateTokensAndExpiration(t,i,r){this.refreshToken=i||null,this.accessToken=t||null,this.expirationTime=Date.now()+r*1e3}static fromJSON(t,i){const{refreshToken:r,accessToken:o,expirationTime:c}=i,h=new Fs;return r&&(X(typeof r=="string","internal-error",{appName:t}),h.refreshToken=r),o&&(X(typeof o=="string","internal-error",{appName:t}),h.accessToken=o),c&&(X(typeof c=="number","internal-error",{appName:t}),h.expirationTime=c),h}toJSON(){return{refreshToken:this.refreshToken,accessToken:this.accessToken,expirationTime:this.expirationTime}}_assign(t){this.accessToken=t.accessToken,this.refreshToken=t.refreshToken,this.expirationTime=t.expirationTime}_clone(){return Object.assign(new Fs,this.toJSON())}_performRefresh(){return Rn("not implemented")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function xC(s,t,i=!1){const{auth:r}=s;if(Yt(r.app))return Promise.reject(Wi(r));const o="reauthenticate";try{const c=await wr(s,Wv(r,o,t,s),i);X(c.idToken,r,"internal-error");const h=bh(c.idToken);X(h,r,"internal-error");const{sub:d}=h;return X(s.uid===d,r,"user-mismatch"),ta._forOperation(s,o,c)}catch(c){throw(c==null?void 0:c.code)==="auth/user-not-found"&&ln(r,"user-mismatch"),c}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ry(s,t){return t?On(t):(X(s._popupRedirectResolver,s,"argument-error"),s._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wh extends Zv{constructor(t){super("custom","custom"),this.params=t}_getIdTokenResponse(t){return Ks(t,this._buildIdpRequest())}_linkToIdToken(t,i){return Ks(t,this._buildIdpRequest(i))}_getReauthenticationResolver(t){return Ks(t,this._buildIdpRequest())}_buildIdpRequest(t){const i={requestUri:this.params.requestUri,sessionId:this.params.sessionId,postBody:this.params.postBody,tenantId:this.params.tenantId,pendingToken:this.params.pendingToken,returnSecureToken:!0,returnIdpCredential:!0};return t&&(i.idToken=t),i}}function e1(s){return UC(s.auth,new wh(s),s.bypassAuthState)}function t1(s){const{auth:t,user:i}=s;return X(i,t,"internal-error"),xC(i,new wh(s),s.bypassAuthState)}async function n1(s){const{auth:t,user:i}=s;return X(i,t,"internal-error"),IC(i,new wh(s),s.bypassAuthState)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const If="webStorageSupport";class q1{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=ty,this._completeRedirectFn=f1,this._overrideRedirectResult=o1}async _openPopup(t,i,r,o){var c;xn((c=this.eventManagers[t._key()])===null||c===void 0?void 0:c.manager,"_initialize() not called before _openPopup()");const h=await Dg(t,i,r,Qf(),o);return k1(t,h,Ah())}async _openRedirect(t,i,r,o){await this._originValidation(t);const c=await Dg(t,i,r,Qf(),o);return GC(c),new Promise(()=>{})}_initialize(t){const i=t._key();if(this.eventManagers[i]){const{manager:o,promise:c}=this.eventManagers[i];return o?Promise.resolve(o):(xn(c,"If manager is not set, promise should be"),c)}const r=this.initAndGetManager(t);return this.eventManagers[i]={promise:r},r.catch(()=>{delete this.eventManagers[i]}),r}async initAndGetManager(t){const i=await O1(t),r=new d1(t);return i.register("authEvent",o=>(X(o==null?void 0:o.authEvent,t,"invalid-auth-event"),{status:r.onEvent(o.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[t._key()]={manager:r},this.iframes[t._key()]=i,r}_isIframeWebStorageSupported(t,i){this.iframes[t._key()].send(If,{type:If},o=>{var c;const h=(c=o==null?void 0:o[0])===null||c===void 0?void 0:c[If];h!==void 0&&i(!!h),ln(t,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(t){const i=t._key();return this.originValidationPromises[i]||(this.originValidationPromises[i]=v1(t)),this.originValidationPromises[i]}get _shouldInitProactively(){return Fv()||qv()||Sh()}}const j1=q1;var Mg="@firebase/auth",Ig="1.9.1";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fo{getCompare(){return this.compare.bind(this)}indexedValueChanged(t,i){const r=new ne(na,t),o=new ne(na,i);return this.compare(r,o)!==0}minPost(){return ne.MIN}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sw extends Fo{constructor(t){super(),this.indexPath_=t,k(!ae(t)&&te(t)!==".priority","Can't create PathIndex with empty path or .priority key")}extractChild(t){return t.getChild(this.indexPath_)}isDefinedOn(t){return!t.getChild(this.indexPath_).isEmpty()}compare(t,i){const r=this.extractChild(t.node),o=this.extractChild(i.node),c=r.compareTo(o);return c===0?ua(t.name,i.name):c}makePost(t,i){const r=Fe(t),o=Q.EMPTY_NODE.updateChild(this.indexPath_,r);return new ne(i,o)}maxPost(){const t=Q.EMPTY_NODE.updateChild(this.indexPath_,jr);return new ne(ts,t)}toString(){return Uy(this.indexPath_,0).join("/")}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class aw extends Fo{compare(t,i){const r=t.node.compareTo(i.node);return r===0?ua(t.name,i.name):r}isDefinedOn(t){return!0}indexedValueChanged(t,i){return!t.equals(i)}minPost(){return ne.MIN}maxPost(){return ne.MAX}makePost(t,i){const r=Fe(t);return new ne(i,r)}toString(){return".value"}}const rw=new aw;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xo{constructor(t,i,r){this.path=t,this.affectedTree=i,this.revert=r,this.type=Zt.ACK_USER_WRITE,this.source=Gy()}operationForChild(t){if(ae(this.path)){if(this.affectedTree.value!=null)return k(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const i=this.affectedTree.subtree(new Se(t));return new xo(he(),i,this.revert)}}else return k(te(this.path)===t,"operationForChild called for unrelated child."),new xo(Ce(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Mr{constructor(t,i){this.source=t,this.path=i,this.type=Zt.LISTEN_COMPLETE}operationForChild(t){return ae(this.path)?new Mr(this.source,he()):new Mr(this.source,Ce(this.path))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ns{constructor(t,i,r){this.source=t,this.path=i,this.snap=r,this.type=Zt.OVERWRITE}operationForChild(t){return ae(this.path)?new ns(this.source,he(),this.snap.getImmediateChild(t)):new ns(this.source,Ce(this.path),this.snap)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let zf;const Ew=()=>(zf||(zf=new Et(aA)),zf);class Ae{static fromObject(t){let i=new Ae(null);return St(t,(r,o)=>{i=i.set(new Se(r),o)}),i}constructor(t,i=Ew()){this.value=t,this.children=i}isEmpty(){return this.value===null&&this.children.isEmpty()}findRootMostMatchingPathAndValue(t,i){if(this.value!=null&&i(this.value))return{path:he(),value:this.value};if(ae(t))return null;{const r=te(t),o=this.children.get(r);if(o!==null){const c=o.findRootMostMatchingPathAndValue(Ce(t),i);return c!=null?{path:Pe(new Se(r),c.path),value:c.value}:null}else return null}}findRootMostValueAndPath(t){return this.findRootMostMatchingPathAndValue(t,()=>!0)}subtree(t){if(ae(t))return this;{const i=te(t),r=this.children.get(i);return r!==null?r.subtree(Ce(t)):new Ae(null)}}set(t,i){if(ae(t))return new Ae(i,this.children);{const r=te(t),c=(this.children.get(r)||new Ae(null)).set(Ce(t),i),h=this.children.insert(r,c);return new Ae(this.value,h)}}remove(t){if(ae(t))return this.children.isEmpty()?new Ae(null):new Ae(null,this.children);{const i=te(t),r=this.children.get(i);if(r){const o=r.remove(Ce(t));let c;return o.isEmpty()?c=this.children.remove(i):c=this.children.insert(i,o),this.value===null&&c.isEmpty()?new Ae(null):new Ae(this.value,c)}else return this}}get(t){if(ae(t))return this.value;{const i=te(t),r=this.children.get(i);return r?r.get(Ce(t)):null}}setTree(t,i){if(ae(t))return i;{const r=te(t),c=(this.children.get(r)||new Ae(null)).setTree(Ce(t),i);let h;return c.isEmpty()?h=this.children.remove(r):h=this.children.insert(r,c),new Ae(this.value,h)}}fold(t){return this.fold_(he(),t)}fold_(t,i){const r={};return this.children.inorderTraversal((o,c)=>{r[o]=c.fold_(Pe(t,o),i)}),i(t,this.value,r)}findOnPath(t,i){return this.findOnPath_(t,he(),i)}findOnPath_(t,i,r){const o=this.value?r(i,this.value):!1;if(o)return o;if(ae(t))return null;{const c=te(t),h=this.children.get(c);return h?h.findOnPath_(Ce(t),Pe(i,c),r):null}}foreachOnPath(t,i){return this.foreachOnPath_(t,he(),i)}foreachOnPath_(t,i,r){if(ae(t))return this;{this.value&&r(i,this.value);const o=te(t),c=this.children.get(o);return c?c.foreachOnPath_(Ce(t),Pe(i,o),r):new Ae(null)}}foreach(t){this.foreach_(he(),t)}foreach_(t,i){this.children.inorderTraversal((r,o)=>{o.foreach_(Pe(t,r),i)}),this.value&&i(t,this.value)}foreachChild(t){this.children.inorderTraversal((i,r)=>{r.value&&t(i,r.value)})}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Jt{constructor(t){this.writeTree_=t}static empty(){return new Jt(new Ae(null))}}function yr(s,t,i){if(ae(t))return new Jt(new Ae(i));{const r=s.writeTree_.findRootMostValueAndPath(t);if(r!=null){const o=r.path;let c=r.value;const h=ft(o,t);return c=c.updateChild(h,i),new Jt(s.writeTree_.set(o,c))}else{const o=new Ae(i),c=s.writeTree_.setTree(t,o);return new Jt(c)}}}function ev(s,t,i){let r=s;return St(i,(o,c)=>{r=yr(r,Pe(t,o),c)}),r}function tv(s,t){if(ae(t))return Jt.empty();{const i=s.writeTree_.setTree(t,new Ae(null));return new Jt(i)}}function $f(s,t){return ss(s,t)!=null}function ss(s,t){const i=s.writeTree_.findRootMostValueAndPath(t);return i!=null?s.writeTree_.get(i.path).getChild(ft(i.path,t)):null}function nv(s){const t=[],i=s.writeTree_.value;return i!=null?i.isLeafNode()||i.forEachChild(Ie,(r,o)=>{t.push(new ne(r,o))}):s.writeTree_.children.inorderTraversal((r,o)=>{o.value!=null&&t.push(new ne(r,o.value))}),t}function vi(s,t){if(ae(t))return s;{const i=ss(s,t);return i!=null?new Jt(new Ae(i)):new Jt(s.writeTree_.subtree(t))}}function eh(s){return s.writeTree_.isEmpty()}function sa(s,t){return Qy(he(),s.writeTree_,t)}function Qy(s,t,i){if(t.value!=null)return i.updateChild(s,t.value);{let r=null;return t.children.inorderTraversal((o,c)=>{o===".priority"?(k(c.value!==null,"Priority writes must always be leaf nodes"),r=c.value):i=Qy(Pe(s,o),c,i)}),!i.getChild(s).isEmpty()&&r!==null&&(i=i.updateChild(Pe(s,".priority"),r)),i}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
to {
  ...
  animation: ${QN} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,XN=({toast:s})=>{let{icon:t,type:i,iconTheme:r}=s;return t!==void 0?typeof t=="string"?re.createElement(FN,null,t):t:i==="blank"?null:re.createElement(YN,null,re.createElement(PN,{...r}),i!=="loading"&&re.createElement(GN,null,i==="error"?re.createElement(HN,{...r}):re.createElement(VN,{...r})))},KN=s=>`
...
`,tO=(s,t)=>{let i=s.includes("top")?1:-1,[r,o]=I0()?[WN,JN]:[KN(i),ZN(i)];return{animation:t?`${kn(r)} 0.35s cubic-bezier(.21,1.02,.73,1) forwards`:`${kn(o)} 0.4s forwards cubic-bezier(.06,.71,.55,1)`}},nO=re.memo(({toast:s,position:t,style:i,children:r})=>{let o=s.height?tO(s.position||t||"top-center",s.visible):{opacity:0},c=re.createElement(XN,{toast:s}),h=re.createElement(eO,{...s.ariaProps},qo(s.message,s));return re.createElement($N,{className:s.className,style:{...o,...i,...s.style}},typeof r=="function"?r({icon:c,message:h}):re.createElement(re.Fragment,null,c,h))});TN(re.createElement);var iO=({id:s,className:t,style:i,onHeightUpdate:r,children:o})=>{let c=re.useCallback(h=>{if(h){let d=()=>{let m=h.getBoundingClientRect().height;r(s,m)};d(),new MutationObserver(d).observe(h,{subtree:!0,childList:!0,characterData:!0})}},[s,r]);return re.createElement("div",{ref:c,className:t,style:i},o)},sO=(s,t)=>{let i=s.includes("top"),r=i?{top:0}:{bottom:0},o=s.includes("center")?{justifyContent:"center"}:s.includes("right")?{justifyContent:"flex-end"}:{};return{left:0,right:0,display:"flex",position:"absolute",transition:I0()?void 0:"all 230ms cubic-bezier(.21,1.02,.73,1)",transform:`translateY(${t*(i?1:-1)}px)`,...r,...o}},aO=iu`
  z-index: 9999;
  > * {
    pointer-events: auto;
  }
`,fo=16,rO=({reverseOrder:s,position:t="top-center",toastOptions:i,gutter:r,children:o,containerStyle:c,containerClassName:h})=>{let{toasts:d,handlers:m}=UN(i);return re.createElement("div",{id:"_rht_toaster",style:{position:"fixed",zIndex:9999,top:fo,left:fo,right:fo,bottom:fo,pointerEvents:"none",...c},className:h,onMouseEnter:m.startPause,onMouseLeave:m.endPause},d.map(_=>{let v=_.position||t,E=m.calculateOffset(_,{reverseOrder:s,gutter:r,defaultPosition:t}),C=sO(v,E);return re.createElement(iO,{id:_.id,key:_.id,onHeightUpdate:m.updateHeight,className:_.visible?aO:"",style:C},_.type==="custom"?qo(_.message,_):o?o(_):re.createElement(nO,{toast:_,position:v}))}))},Tr=ct;function lO({card:s,user:t}){const i=(t==null?void 0:t.uid)==="wTI7A4DRDtMToBfr3ijoPQA9BQX2",r=async()=>{if(window.confirm("Are you sure you want to delete this challenge?"))try{await XR(Ft(Xt,`challenges/${s.id}`)),Tr.success("Challenge deleted")}catch(c){console.error("Failed to delete:",c),Tr.error("Failed to delete challenge")}};return K.jsxs("div",{className:"bg-white rounded-xl shadow hover:shadow-lg transition overflow-hidden",children:[K.jsx("img",{src:s.imageURL,alt:s.challengeText,className:"w-full h-48 object-cover"}),K.jsxs("div",{className:"p-4 space-y-2",children:[K.jsx("h3",{className:"font-semibold text-gray-800",children:s.challengeText}),K.jsxs("div",{className:"flex items-center justify-between",children:[K.jsx(_N,{challengeId:s.id,user:t}),i&&K.jsx("button",{onClick:r,className:"text-red-600 hover:underline text-sm",children:"Delete"})]})]})]})}const oO="onshot_unsigned",uO="dhsgvtewc",cO=(s,t=1024)=>new Promise(i=>{const r=new FileReader;r.onload=o=>{const c=new Image;c.onload=()=>{let h=c.width,d=c.height;h>d&&h>t?(d=d*(t/h),h=t):d>t&&(h=h*(t/d),d=t);const m=document.createElement("canvas");m.width=h,m.height=d,m.getContext("2d").drawImage(c,0,0,h,d),m.toBlob(_=>i(_),"image/jpeg",.85)},c.src=o.target.result},r.readAsDataURL(s)}),fO=async s=>{var o;const t=new FormData;t.append("file",s),t.append("upload_preset",oO);const i=await fetch(`https://api.cloudinary.com/v1_1/${uO}/image/upload`,{method:"POST",body:t}),r=await i.json();if(!i.ok||!r.secure_url)throw new Error(((o=r.error)==null?void 0:o.message)||"Cloudinary upload failed");return r.secure_url};function hO({user:s,challenge:t}){const[i,r]=re.useState(null),[o,c]=re.useState(!1),h=async d=>{if(d.preventDefault(),!t||!i)return Tr.error("Challenge and file required");c(!0);try{const m=await cO(i),_=await fO(m),v=FR(Ft(Xt,"challenges"));await Js(v,{challengeText:t.text,challengeName:t.name||null,imageURL:_,createdAt:Date.now(),createdBy:{uid:s.uid,name:s.displayName,photo:s.photoURL}}),Tr.success("Challenge posted!"),r(null)}catch(m){console.error("Error uploading challenge:",m),Tr.error("Upload failed. See console.")}c(!1)};return K.jsxs("form",{onSubmit:h,className:"bg-white p-6 rounded-xl shadow space-y-4 max-w-xl mx-auto",children:[t&&K.jsx(mN,{text:t.text,type:"daily",name:t.name}),K.jsx("input",{type:"file",accept:"image/*",onChange:d=>r(d.target.files[0]),className:"w-full"}),K.jsx("button",{type:"submit",disabled:o,className:"px-6 py-3 bg-green-500 text-white rounded-full hover:bg-green-600 transition disabled:opacity-50",children:o?"Posting…":"Post Challenge"})]})}function dO({user:s}){const[t,i]=re.useState([]),[r,o]=re.useState(null);return re.useEffect(()=>{s!=null&&s.uid&&(dN(i),hN(s.uid).then(o))},[s==null?void 0:s.uid]),K.jsxs("div",{className:"space-y-6",children:[K.jsx(hO,{user:s,challenge:r}),K.jsx("div",{className:"grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6",children:t.map(c=>K.jsx(lO,{card:c,user:s},c.id))})]})}function pO({user:s,onSignOut:t}){return K.jsxs("nav",{className:"bg-blue-600 text-white p-4 rounded mb-6 flex justify-between items-center",children:[K.jsx("h1",{className:"text-xl font-bold",children:"Card Challenge"}),K.jsxs("div",{className:"flex items-center space-x-3",children:[s.photoURL&&K.jsx("img",{src:s.photoURL,alt:s.displayName,className:"w-8 h-8 rounded-full"}),K.jsx("button",{onClick:t,className:"px-3 py-1 bg-white text-blue-600 rounded hover:bg-gray-200 transition",children:"Sign Out"})]})]})}function mO(){const[s,t]=re.useState([]);return re.useEffect(()=>{const i=new Date().toISOString().split("T")[0],r=Ft(Xt,"users"),o=N0(r,c=>{const h=c.val();if(!h)return;const d=Object.values(h).filter(m=>m.uploads&&m.uploads[i]);t(d)});return()=>o()},[]),K.jsxs("aside",{className:"w-full sm:w-64 bg-white p-4 rounded-xl shadow mb-6",children:[K.jsx("h2",{className:"text-lg font-bold mb-4",children:"Today's Uploaders"}),K.jsxs("ul",{className:"space-y-3",children:[s.map((i,r)=>K.jsxs("li",{className:"flex items-center space-x-3",children:[K.jsx("img",{src:i.photoURL,alt:i.displayName,className:"w-8 h-8 rounded-full"}),K.jsx("span",{className:"text-gray-800",children:i.displayName})]},r)),s.length===0&&K.jsx("li",{className:"text-gray-500 italic text-sm",children:"No uploads yet today"})]})]})}function _O(){const[s,t]=re.useState(null);return re.useEffect(()=>cN(t),[]),s?K.jsxs(K.Fragment,{children:[K.jsx(rO,{position:"top-center"}),K.jsx(pO,{user:s,onSignOut:uN}),K.jsxs("div",{className:"flex flex-col lg:flex-row max-w-6xl mx-auto px-4 gap-6",children:[K.jsx("div",{className:"flex-1",children:K.jsx(dO,{user:s})}),K.jsx("div",{className:"w-full lg:w-72",children:K.jsx(mO,{})})]})]}):K.jsx(pN,{})}dS.createRoot(document.getElementById("root")).render(K.jsx(aS.StrictMode,{children:K.jsx(_O,{})}));
